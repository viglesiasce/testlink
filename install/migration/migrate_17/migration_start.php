...
<br />
         ...
         <div>
				...
				<div>
				 Name of your existent TestLink 1.7.2 database<p>
				<div class="labelHolder"><label for="source_databasename">Database name:</label></div>
					<input type="text" id="source_databasename" name="source_databasename" 
                 maxlength="50" 
					       style="width:200px" value="(your testlink db name)"><br />
        </div>
				<p class="fancy">
				</div>
				</p>
