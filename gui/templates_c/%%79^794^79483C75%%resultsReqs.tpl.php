<?php /* Smarty version 2.6.26, created on 2010-09-16 12:06:31
         compiled from results/resultsReqs.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'results/resultsReqs.tpl', 18, false),array('modifier', 'escape', 'results/resultsReqs.tpl', 39, false),array('modifier', 'date_format', 'results/resultsReqs.tpl', 65, false),)), $this); ?>
<?php echo lang_get_smarty(array('var' => 'labels','s' => 'title_result_req_testplan, show_only_finished_reqs, generated_by_TestLink_on'), $this);?>
...
<input type="checkbox" name="show_only_finished" value="show_only_finished"
       <?php if ($this->_tpl_vars['gui']->show_only_finished): ?> checked="checked" <?php endif; ?>
       onclick="this.form.submit();" /> <?php echo $this->_tpl_vars['labels']['show_only_finished_reqs']; ?>

<input type="hidden"
       name="show_only_finished_hidden"
       value="<?php echo $this->_tpl_vars['gui']->show_only_finished; ?>
" />
</form></p><br/>
